...
namespace demod {
    ...
    public:
        ...
        void showMenu() {
            ...
            ImGui::LeftLabel(_("Tone Frequency"));
            ImGui::FillWidth();
            if (ImGui::InputInt((std::string(_("Stereo##_radio_cw_tone_")) + name).c_str(), &tone, 10, 100)) {
